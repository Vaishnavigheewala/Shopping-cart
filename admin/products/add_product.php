<?php
$mysqli = new mysqli(hostname: "localhost", username: "root", password: "asdf", database: "shoppingcart");
session_start();
...
h1 {
    color: #da33ff; /* Green color for the header */
    text-align: center;
    margin-bottom: 20px;
}
...
.btn {
    ...
    padding: 10px 20px;
    background-color: #da33ff; /* Button color */
    color: white;
...
.btn:hover {
    background-color: #da33ff; /* Darker green on hover */
}
...
.back-btn:hover {
    background-color: #da33ff; /* Darker blue on hover */
}
